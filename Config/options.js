/**
 * SAP Configurations Chrome Extension - Options Page
 * Handles settings management and default configuration.
 */

// Checkbox ids are the storage key prefixed with this string (e.g. mSol -> xmSol)
const CHECKBOX_PREFIX = 'x';

// Settings configuration (key = storage key, label = documentation only)
const SETTINGS_CONFIG = [
    { key: 'mSol', label: 'Manage Your Solutions' },
    { key: 'mWF', label: 'Manage INV Workflows' },
    { key: 'mWFPO', label: 'Manage PO Workflows' }
];
